...
function appUrl() {
  return process.env.CLIENT_URL || "https://musely.tech";
}
...
<html lang="en">
  <body style="margin:0;padding:0;background:#f7f7f5;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">Your Musely access is ready — sign in to start writing.</div>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f7f5;padding:40px 16px;">
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#ffffff;border:1px solid #e7e7e2;border-radius:16px;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
            ...
            <tr>
              <td style="padding:28px 40px 0 40px;">
                <h1 style="margin:0;font-size:24px;line-height:1.3;color:${INK};font-weight:700;letter-spacing:-0.4px;">You're in 🎉</h1>
                <p style="margin:16px 0 0 0;font-size:15px;line-height:1.65;color:${MUTED};">
                  Your spot on Musely is ready. You can now sign in and start turning ideas into
                  finished drafts — Musely helps you beat the blank page and write more.
                </p>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 40px 0 40px;">
                <a href="${url}" style="display:inline-block;background:${ACCENT};color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:13px 26px;border-radius:10px;">
                  Sign in to Musely
                </a>
                <p style="margin:14px 0 0 0;font-size:13px;line-height:1.6;color:${MUTED};">
                  Use the <strong>Sign in</strong> button and continue with the Google account tied to this email.
                </p>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 40px 40px 40px;">
                <p style="margin:0;font-size:14px;line-height:1.6;color:${MUTED};">
                  Questions? Just reply to this email — we're glad you're here.
                </p>
                <p style="margin:20px 0 0 0;font-size:14px;line-height:1.6;color:${INK};">— The Musely team</p>
              </td>
            </tr>
          </table>
          <p style="max-width:480px;margin:20px auto 0 auto;font-size:12px;line-height:1.5;color:#9aa0a6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;text-align:center;">
...
function approvalText() {
  return [
    "You're in!",
    "",
    "Your spot on Musely is ready. Sign in and start turning ideas into finished drafts.",
    "",
    `Sign in: ${appUrl()}`,
    "Use the Sign in button and continue with the Google account tied to this email.",
    "",
...
export async function sendWaitlistApproval(to) {
  return sendEmail({
    to,
    subject: "You're in — your Musely access is ready",
    html: approvalHtml(),
    text: approvalText(),
  });
}
